...
export const VDJ_STR = {
  ...
  sectionIntro:            { en: "Tick songs in the Library (VDJ column) and let Virtual DJ mix them professionally.",
                              es: "Marca canciones en la Library (columna VDJ) y deja que el Virtual DJ las mezcle profesionalmente." },
  ...
  shuffle:                 { en: "Shuffle order",                                 es: "Orden aleatorio (shuffle)" },
  ...
  cutAtTip:                { en: "Percentage of the track where the transition starts (50–95%)", es: "Porcentaje del track al que se inicia la transición (50–95%)" },
  xfadeSec:                { en: "Crossfade duration (s)",                        es: "Duración crossfade (s)" },
  xfadeAuto:               { en: "0 = automatic per genre",                       es: "0 = automático según el género" },
  syncBpm:                 { en: "Sync BPM",                                      es: "Sincronizar BPM (Sync)" },
  autoGain:                { en: "AutoGain per track",                            es: "AutoGain por pista" },
  useFx:                   { en: "Apply FX on transition",                        es: "Aplicar efectos (FX) en transición" },
  useLoops:                { en: "Automatic loops",                               es: "Loops automáticos" },
  useHotCues:              { en: "Automatic hot cues",                            es: "Hot cues automáticos" },
  useScratch:              { en: "Scratch flourish",                              es: "Scratch flourish" },
  usePitchBend:            { en: "Pitch bend (micro-tweaks)",                     es: "Pitch bend (micro-ajustes)" },
  useSpice:                { en: "Spice (sweeps + mid loop)",                     es: "Spice (sweeps + loop a mitad)" },
  useSpiceTip:             { en: "Filters, loops, scratch and bends mid-track",   es: "Filtros, loops, scratch y bends a mitad de cada pista" },
  ...
  outroPro:                { en: "Pro outro (brake + reverb)",                    es: "Outro profesional (brake + reverb)" },
  brakeSec:                { en: "Final brake duration (s)",                      es: "Duración del brake final (s)" },
  ...
  energyCurve:             { en: "Energy Curve (set planner)",                    es: "Energy Curve (planificador de set)" },
  energyCurveTip:          { en: "Reorders selected tracks following a pro warmup → peak → cooldown curve (BPM + Camelot)",
                              es: "Reordena las pistas seleccionadas siguiendo una curva profesional warmup → peak → cooldown (BPM + Camelot)" },
  energyShape:             { en: "Curve shape",                                   es: "Forma de la curva" },
  shapeArc:                { en: "🏔 Arc (warmup → peak → cooldown)",             es: "🏔 Arco (warmup → peak → cooldown)" },
  ...
  echoFreeze:              { en: "Echo-Freeze + Cut (Pioneer transition)",        es: "Echo-Freeze + Cut (transición Pioneer)" },
  echoFreezeTip:           { en: "Freezes the outgoing's last bar with echo and cuts dry on the incoming downbeat",
                              es: "Congela el último compás del outgoing con echo y corta seco al downbeat del incoming" },
  echoFreezeProb:          { en: "Echo-Freeze probability (%)",                   es: "Probabilidad Echo-Freeze (%)" },
  echoFreezeProbTip:       { en: "% of transitions that will use Echo-Freeze instead of the classic crossfade",
                              es: "% de transiciones que usarán Echo-Freeze en lugar del crossfade clásico" },
  phraseAlign:             { en: "Align cut to downbeat / drop",                  es: "Alinear corte al downbeat / drop" },
  phraseAlignTip:          { en: "Wait for the next downbeat or phrase marker (drop/buildup) before cutting — perfectly square transitions",
                              es: "Espera al próximo downbeat o phrase marker (drop/buildup) antes de cortar — transiciones perfectamente cuadradas" },
  phraseWindow:            { en: "Downbeat wait window (s)",                      es: "Ventana de espera al downbeat (s)" },
  phraseWindowTip:         { en: "If no downbeat/drop appears within the window, cut anyway so the mix keeps moving",
                              es: "Si no aparece downbeat/drop dentro de la ventana, corta igual para no bloquear la mezcla" },

  mashup:                  { en: "Mash-up Double Drop",                           es: "Mash-up Double Drop" },
  mashupTip:               { en: "Both tracks play N bars with EQ split (lows from A, highs from B) before the cut",
                              es: "Ambas pistas suenan N compases con EQ split (lows del A, highs del B) antes del corte" },
  mashupProb:              { en: "Mash-up probability (%)",                       es: "Probabilidad Mash-up (%)" },
  mashupBars:              { en: "Double Drop bars",                              es: "Compases del Double Drop" },
  stemAware:               { en: "Stem-aware (vocal duck on outgoing)",           es: "Stem-aware (vocal duck en outgoing)" },
  ...
  stemAmt:                 { en: "Vocal cancellation amount (%)",                 es: "Cantidad de cancelación vocal (%)" },
  battle:                  { en: "⚔ Battle Mode (turntablism)",                   es: "⚔ Battle Mode (turntablism)" },
  ...
  battleProb:              { en: "Battle probability (%)",                        es: "Probabilidad Battle (%)" },
  battleBars:              { en: "Bars per Battle round",                         es: "Compases por ronda Battle" },
  battleRounds:            { en: "Battle rounds",                                 es: "Rondas de Battle" },
  bars:                    { en: "{n} bars",                                      es: "{n} compases" },

  micShoutout:             { en: "Sidechain mic shoutouts",                       es: "Sidechain mic shoutouts" },
  micShoutoutTip:          { en: "Detects when you speak into the mic and ducks the master automatically",
                              es: "Detecta cuando hablas por el micrófono y atenúa el master automáticamente" },
  micThresh:               { en: "Mic threshold (%)",                             es: "Umbral del mic (%)" },
  duckDepth:               { en: "Duck depth (%)",                                es: "Profundidad del duck (%)" },
  moodAdaptive:            { en: "Mood adaptive (genre arc)",                     es: "Mood adaptativo (arco de género)" },
  moodAdaptiveTip:         { en: "Automatically changes the target genre every N tracks (chill → peak → cooldown)",
                              es: "Cambia automáticamente el género objetivo cada N pistas (chill → peak → cooldown)" },
  moodEvery:               { en: "Change mood every N tracks",                    es: "Cambiar mood cada N pistas" },
  moodShape:               { en: "Mood shape",                                    es: "Forma del mood" },
  exportCue:               { en: "Export cue sheet (.cue) when finished",         es: "Exportar cue sheet (.cue) al terminar" },
  exportCueTip:            { en: "Downloads a .cue file with each transition's timestamps alongside the recording",
                              es: "Descarga un archivo .cue con los timestamps de cada transición junto con la grabación" },
  autoStream:              { en: "Live streaming (auto)",                         es: "Streaming en vivo (auto)" },
  autoStreamTip:           { en: "Automatically starts the Icecast broadcast at set start and updates per-track metadata",
                              es: "Inicia el broadcast Icecast automáticamente al arrancar el set y actualiza la metadata por pista" },
  beatjuggleLbl:           { en: "Beatjuggling (on slow tracks)",                 es: "Beatjuggling (en pistas lentas)" },
  ...
  beatjuggleMaxBpm:        { en: "Beatjuggle max BPM",                            es: "BPM máximo para beatjuggle" },
  beatjuggleProb:          { en: "Beatjuggle probability (%)",                    es: "Probabilidad beatjuggle (%)" },
  radioShow:               { en: "📻 Radio Show mode",                            es: "📻 Modo Radio Show" },
  ...
  radioJingleTrack:        { en: "Jingle track (Library)",                        es: "Pista jingle (Library)" },
  none:                    { en: "— none —",                                      es: "— ninguna —" },

  harmonic:                { en: "🎼 Harmonic Mixing AI (real Camelot)",          es: "🎼 Harmonic Mixing AI (Camelot real)" },
  harmonicTip:             { en: "Detects real key and reorders so each jump is Camelot-compatible",
                              es: "Detecta key real y reordena para que cada salto sea Camelot-compatible" },
  acapellaLayerLbl:        { en: "🎤 Acapella & Instrumental Layering",           es: "🎤 Acapella & Instrumental Layering" },
  acapellaProb:            { en: "Acapella probability (%)",                      es: "Probabilidad acapella (%)" },
  acapellaBars:            { en: "Layering bars",                                 es: "Compases de layering" },
  loopRoll:                { en: "🌀 Automatic Loop Roll",                        es: "🌀 Loop Roll automático" },
  loopRollProb:            { en: "Loop Roll probability (%)",                     es: "Probabilidad Loop Roll (%)" },
  energyMeter:             { en: "📊 Crowd Energy Meter (overlay)",               es: "📊 Crowd Energy Meter (overlay)" },
  reverseFx:               { en: "↩ Reverse Censor FX",                           es: "↩ Reverse Censor FX" },
  reverseProb:             { en: "Reverse probability (%)",                       es: "Probabilidad reverse (%)" },
  reverseBars:             { en: "Reverse bars",                                  es: "Compases reverse" },
  dropBuilder:             { en: "🎢 Auto Drop Builder (riser+snare)",            es: "🎢 Auto Drop Builder (riser+snare)" },
  dropBuilderProb:         { en: "Drop Builder probability (%)",                  es: "Probabilidad drop builder (%)" },
  dropBuilderSec:          { en: "Riser duration (s)",                            es: "Duración riser (s)" },
  voiceCmd:                { en: "🎙 Voice Command Mode",                         es: "🎙 Modo Comando por Voz" },
  voiceCmdTip:             { en: "Say: 'next', 'pause', 'play', 'reverse', 'drop', 'scratch'",
                              es: "Di: 'siguiente', 'pausa', 'play', 'reverse', 'drop', 'scratch'" },
  autoMashup:              { en: "💥 Auto Mashup Generator",                      es: "💥 Auto Mashup Generator" },
  autoMashupEvery:         { en: "Mashup every N tracks",                         es: "Mashup cada N pistas" },
  mixReportPdf:            { en: "📄 Mix Report PDF when finished",               es: "📄 Mix Report PDF al finalizar" },

  // ===== v1.7.7: skin + smart autonomy =====
  defaultSkin:             { en: "Virtual DJ default skin",                       es: "Skin por defecto del Virtual DJ" },
  defaultSkinTip:          { en: "Applied automatically when the Virtual DJ starts; the previous skin is restored on stop.",
                              es: "Se aplica automáticamente al iniciar el Virtual DJ; el skin previo se restaura al detener." },
  ...
  smartTighten:            { en: "Tight transitions (no gaps)",                   es: "Transiciones ajustadas (sin huecos)" },
  smartTightenTip:         { en: "Pre-load the next track earlier and pre-roll it muted so the crossfade has zero gap.",
                              es: "Pre-carga la siguiente pista antes y la pre-rueda en mute para crossfade sin huecos." },
  showStatusOverlay:       { en: "Show 'mixing' overlay",                         es: "Mostrar overlay de 'mezclando'" },
